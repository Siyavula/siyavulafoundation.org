  ...
  $(document).ready(function() {
      ...
      $('.top-bar-section a', ctx).click(function(event) {
        ...
        try {
          if ( $(this).attr('href') == '#top' ) {
            ...
            distance = $($(this).attr('href')).offset().top - headerHeight + 'px';
          }
    ...
    $('#contact_form').submit(function(event) {
      ...
      $.ajax({
        ...
        data: {
          "key": "eT5GtnFipJe4vXantH979Q",
          "message": {
            "from_email": "info@siyavula.com",
            "from_name": name,
            "headers": {
              "Reply-To": email
            },
            "subject": "Query from Corporate Website",
            "text": message,
            "to": [{
              "email": "info@siyavula.com",
              "name": "Siyavula",
              "type": "to"
            }]
          }
      ...
      .done(function(response) {
        ...
        $('#name').before('<div id="message_result" class="success">Thanks! Your message was sent successfully. We&#39;ll get in touch with you shortly.</div');
      })
      .fail(function(response) {
        $('#name').before('<div id="message_result" class="failure">Your message could not be sent.</div');
      });
    });
  });
})(jQuery);
